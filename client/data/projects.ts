const projects = [
  ...
  },
  {
    ...
    impact: ["I delivered a working 3D room planner in under 7 days, proving the concept was not only feasible but could be built rapidly with the right approach"],
